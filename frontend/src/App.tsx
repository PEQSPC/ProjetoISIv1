...
import { 
  AppBar, Toolbar, Typography, Container, Button, Card, CardContent, 
  ...
  return (
    <div style={{ backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
      <AppBar position="static">
        <Toolbar>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
            IoT Simulator Manager
          </Typography>
          <Button color="inherit" onClick={() => setOpen(true)} variant="outlined" sx={{ bgcolor: 'white', color: 'primary.main' }}>
            Nova Simulação
          </Button>
        </Toolbar>
      </AppBar>
      ...
      <Container sx={{ mt: 4, mb: 4 }}>
        <Typography variant="h4" gutterBottom>Simulações Ativas</Typography>
